...
REQUEST_JSON="$RUN_ROOT/configs/07_multimodal_learner_request_next_tuning_roc_auc_backbone.json"
OUT_JSON="$RUN_ROOT/api/70_multimodal_submit_next_tuning_roc_auc_backbone.json"
...
out = Path("experiments/exp_multimodal_dataset__ds_hancock_tma__tool_multimodal/runs/run_20260208_232320Z_setup/api/70_multimodal_submit_next_tuning_roc_auc_backbone.json")
